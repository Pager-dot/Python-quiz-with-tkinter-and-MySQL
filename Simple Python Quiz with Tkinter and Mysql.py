...
def Start_tab():
    ...
    start_button.place(x=310,y=420)
...
def tab1():
    ...
    def correct():
        ...
        lable_correct =Label(root,text="True",font=('arial', 30),bg= '#f04d75')
    ...
    def Not_correct():
        ...
        lable_incorrect =Label(root,text="False",font=('arial', 30),bg= '#f04d75')
    ...
    to assign a number to a variable? ''', font=('arial',25),bg= '#f04d75')
    label1.pack()
...
def tab2():
    ...
    print('"Hello world") ''', font=('arial',25),bg= '#f04d75')
    label2.pack()
    global button5
    ...
    button6=Button(root, text="Syntax error", command=Not_correct,\
        font=('arial', 20),height= 3, width=9)
...
def tab4():
    ...
    result of addition of 10 and 7 to get 17 ?''',font=('arial',25),bg= '#f04d75')
    label4.pack()
    global button13
...
def tab5():
    ...
    file name in he command line argument ?''',font=('arial',25),bg= '#f04d75')
    label5.pack()
    global button17
    ...
    button18=Button(root, text='''print("sys.argv[0]")''',\
        command= Not_correct,font=('arial',20),height=2,width=12)
...
def tab6():
    ...
    the arguments in the command line ?''',font=('arial',25),bg= '#f04d75')
    label6.pack()
    global button21
...
def tab9():
    ...
    print (pos * 3)''' , font=('arial',25),bg= '#f04d75')
    label9.pack()
    global button33
    ...
    button35=Button(root, text='''Harsh''', command= Not_correct,\
        height=4,width=11,font=('arial',20))
...
def tab10():
    ...
    print (0.1 + 0.2 == 0.3) ''',font=('arial', 25),bg= '#f04d75')
    label10.pack()
    global button37
...
def tab11():
    ...
    L = [1,2,6,5,7,8]
    L.insert(9)''',font=('arial', 25),bg= '#f04d75')
    label11.pack()
    global button41
...
def tab12():
    ...
    create a function in Python?''',font=('arial', 25),bg= '#f04d75')
    label12.pack()
    global button45
...
def result_tab():
        ...
        def show_result():
            ...
            for x in result:
                marks = Label(root, text= x , font=("Arial", 50),bg= '#f04d75')
